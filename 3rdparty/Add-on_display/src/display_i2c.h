...
class DisplayI2C : public IDisplay
{
    Q_OBJECT
public:
    explicit DisplayI2C();
    ...
    void lcdCharDef(lcd_i2c_t *lcd,int index, unsigned char data [8]);
     ...
     */
    int lcd_i2c_setup( lcd_i2c_t *lcd,int rows, int cols, int address);
